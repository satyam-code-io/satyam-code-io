// # finding the occurence of a string's character from the ending of a string to starting :-
package recursion;
...
public class recursion3{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("enter the string that you want a character occurence for your your own choice :-");
        String s = sc.nextLine();
        System.out.println("enter the element whosse first and last occurence you want :-");
        String x=sc.next();
        int n=s.length();
        printreverse(s.length()-1,s,n,x);
    }
